...
(defn collection
  [name]
  (str "com.etzhayyim.yotei." name))

(def cell-specs {
  :createevent {:legacy-cell "com-etzhayyim-apps-yotei-createEvent"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "createevent")]
     :required-gates common-gates
     :trigger "manifest cell createevent"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-apps-yotei-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :event {:legacy-cell "com-etzhayyim-apps-yotei-event"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :availability {:legacy-cell "com-etzhayyim-apps-yotei-availability"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "availability")]
     :required-gates common-gates
